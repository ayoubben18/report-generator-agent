...
export default function ApprovalPageClient({
    ...
    const handleApproval = async (approvalData: {
        ...
        try {
            console.log("Submitting approval:", { runId, stepId: currentStep, ...approvalData });
            ...
            if (response.ok) {
                // With real-time Convex updates, the UI should update automatically
            ...
            <div className="flex-1 flex relative z-10">
                ...
                <div className="w-1/2 border-r border-white/[0.05] flex flex-col backdrop-blur-2xl bg-white/[0.02]">
                    <div className="p-6 border-b border-white/[0.05]">
                        <h3 className="text-lg font-semibold text-white/90 mb-2">Generated Plan</h3>
                        <p className="text-sm text-white/60">Review the AI-generated report structure</p>
                    </div>
                ...
                <div className="w-1/2 flex flex-col backdrop-blur-2xl bg-white/[0.02]">
                    <div className="p-6 border-b border-white/[0.05]">
                        <h3 className="text-lg font-semibold text-white/90 mb-2">Plan Approval</h3>
